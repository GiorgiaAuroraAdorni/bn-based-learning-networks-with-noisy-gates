...
java -jar target/itas-1.0.jar $Model1 $Answers1 $Results1 "unconstrained"
...
java -jar target/itas-1.0.jar $Model2 $Answers2 $Results2 "constrained"
...
java -jar target/itas-1.0.jar $Model3 $Answers3 $Results3 "constrained"
...
java -jar target/itas-1.0.jar $Model4 $Answers4 $Results4 "constrained"
...
java -jar target/itas-1.0.jar $Model5 $Answers5 $Results5 "constrained"
